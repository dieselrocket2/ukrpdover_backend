...
settings.DataStoreKey = "Dover_V2"			 -- CHANGE THIS TO ANYTHING RANDOM! Key used to encrypt all datastore entries; Changing this will lose any saved data
...
settings.Ranks = {
	...
	["Creators"] = {
		...
		Users = {"Callumboyhd"; "Group:35704052:254"; "Tec_f3x", "Dieselrocket2";
			--// Add users here (Also, don't forget quotations and all that)
		};
	};
};
...
settings.OnJoin = {":setmessage Welcome to UK:RP Dover - Feel free to call staff by saying !help (REASON) in chat - Have a great roleplay experience!"}		-- List of commands ran as player on join (ignores adminlevel)		Format: {":cmds"}
...
settings.PlayerCommands = false			-- Are player-level utility commands enabled?
...
settings.ChatCommands = false			-- If false you will not be able to run commands via the chat; Instead, you MUST use the console or you will be unable to run commands
...
settings.BanMessage = "You are BANNED from UKRP Dover. In-order to appeal, Join our communications server and open a ticket."				-- Message shown to banned users upon kick
settings.LockMessage = "This server is locked, try again."	-- Message shown to people when they are kicked while the game is :slocked
settings.SystemTitle = "UK:RP Dover - System Message"	-- Title to display in :sm and :bc
